 ...
 */
        ...
        /* This type was generated from the piece of schema that had
                name = ArrayOfString
                Namespace URI = http://user.apim.smartcommunitylab.it
                ...
                if (localArrayTracker){
                             if (localArray!=null) {
                                   ...
                                   for (int i = 0;i < localArray.length;i++){
                                        ...
                                        // write null attribute
                                           writeStartElement(null, "http://user.apim.smartcommunitylab.it", "array", xmlWriter);
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"ArrayOfString".equals(type)){
                                ...
                                return (ArrayOfString)org.apache.axis2.transaction.xsd.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                        ...
                        java.util.ArrayList list1 = new java.util.ArrayList();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://user.apim.smartcommunitylab.it","array").equals(reader.getName())){
                                    ...
                                    // Process the array and step past its final element's end.
                                            ...
                                            while(!loopDone1){
                                                ...
                                                if (reader.isEndElement()){
                                                    ...
                                                    if (new javax.xml.namespace.QName("http://user.apim.smartcommunitylab.it","array").equals(reader.getName())){

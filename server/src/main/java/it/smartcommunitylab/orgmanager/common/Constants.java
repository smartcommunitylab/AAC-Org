...
public class Constants {
    ...
    public static final String ROOT_MODELS = "models";
    public static final String ROOT_SPACES = "spaces";
    ...
    public static final String SLUG_SEPARATOR = "."; // TODO use "-" AAC should support it
    public static final String SLUG_FILL = "_"; // keep compatible with separator

...
Once you have configured these two files and Docker is running, open a console and change directory to the root (`AAC-Org`) folder of the project and execute this command to build a Docker image:\
